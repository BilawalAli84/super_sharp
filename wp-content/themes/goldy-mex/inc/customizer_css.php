...
function goldy_mex_customize_css(){
    ...
    if(get_theme_mod('goldy_mex_container_page_layout','content_boxed') == 'content_boxed'){
    	?>
		<style>	
    	.call_button_info, .breadcrumb_data, .goldy_mex_container_info.boxed_layout, .goldy_mex_container_info.content_boxed, .featured_section_info, .our_portfolio_data, .our_team_info, .our_testimonial_info, .our_services_info .widget_section , .services_section_info, .fitness_class_data, .pricing_plan_section_info {
		    max-width: <?php echo esc_attr(get_theme_mod('goldy_mex_container_width','1100')); ?>px;
		    margin-left: auto;
		    margin-right: auto;
		}
